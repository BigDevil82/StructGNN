...
class ComprehensiveTestEvaluator:
    ...
    def evaluate_detailed(self) -> dict:
        ...
        """
        from experiments.metrics.classification_metrics import compute_per_edge_classification_metrics
        from experiments.metrics.regression_metrics import compute_per_edge_regression_metrics
