...
from src.data_engine.pngtool.element_extractor import ElementExtractor
from src.data_engine.pngtool.img_util import resize_img
...
def main():
    """主函数"""
    from src.data_engine.pngtool.image_clustering import ImageClusteringAnalyzer
    ...
    convert_batch(
        ...
        output_dir="data/dxf/to_process/room_raw",
    )
