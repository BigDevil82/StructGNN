...
from ..core.constants import CONCRETE_COMPRESSIVE_STRENGTH_PA, MIN_SHEAR_WEIGHT_RATIO_BY_INTENSITY
from .combinations import cqc, srss
from .modal import identify_dominant_modes, modal_periods_from_eigenvalues, safe_abs_float_list
...
class SeismicCodeChecker:
    ...
    def run_analysis_and_evaluate(self) -> tuple[dict[str, list[float]], dict[str, DirectionCheckResult]]:
        ...
        periods = modal_periods_from_eigenvalues(eigs)
