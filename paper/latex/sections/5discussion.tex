...
Finally, the scale of the dataset (143 floor plans), while comparable to related studies, remains limited relative to the vast diversity of architectural styles \cite{liaoAutomatedStructuralDesign2021a,zhaoIntelligentDesignShear2023b,guIntelligentDesignShear2024}. Future work could address these limitations by exploring graph representations that support arbitrary polygon boundaries and integrating differentiable structural physics into the loss function to guide performance-oriented generation.
