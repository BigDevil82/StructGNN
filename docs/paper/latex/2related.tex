...
\textcolor{red}{This section reviews prior work from three perspectives: automated structural layout generation, graph-based representations, and conditional generation under limited paired data.}
