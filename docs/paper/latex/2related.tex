...
\textcolor{red}{This section reviews prior work from three perspectives: automated structural layout generation, graph-based representations, and conditional generation under limited paired data. These strands motivate the room-level conditional graph formulation proposed in this study.}
