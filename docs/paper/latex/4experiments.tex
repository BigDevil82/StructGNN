...
\textcolor{red}{The dataset construction and statistics are summarized below to clarify the sample scope, condition distribution, and graph scale before model evaluation.}
