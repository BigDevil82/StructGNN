...
\caption{Graph complexity comparison between the component-level and room-level representations}
...
\midrule
Component-level GNN & 244.80 $\pm$ 74.68 & 444.34 $\pm$ 133.08 & -- & -- & -- \\
Room-level GNN & 26.46 $\pm$ 8.69 & 71.61 $\pm$ 29.58 & -- & -- & -- \\
Reduction & 89.2\% & 83.9\% & -- & -- & -- \\
\bottomrule
\end{tabular*}
\par\smallskip
{\small\noindent\parbox{\textwidth}{\raggedright Note: Node and edge statistics are computed on 112 training floor plans.}}
\endgroup
\end{table*}

\textcolor{red}{Table~\ref{tab:efficiency} provides a quantitative comparison of graph complexity. The room-level representation reduces the average number of nodes from 244.80 to 26.46 and the average number of edges from 444.34 to 71.61, corresponding to reductions of 89.2\% and 83.9\%, respectively. This directly supports the claim that representing rooms rather than low-level wall components produces a more compact graph.}
