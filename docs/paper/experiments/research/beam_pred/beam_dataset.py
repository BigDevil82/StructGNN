...
from docs.paper.experiments.research.beam_pred.data_aug import GeometryAugmentor
...
class BeamDataset(InMemoryDataset):
    ...
    def process(self):
        if not self.dxf_files:
            raise RuntimeError("Processed data not found, and 'data/dxf_files' was not provided.")
