...
from docs.paper.experiments.research.beam_pred.beam_dataset import BeamDataset
from docs.paper.experiments.research.beam_pred.model import BeamPredictorGNN


def train_pipeline(dxf_files, save_dir):
    # 1. 准备数据
    dataset = BeamDataset(root="data/cache/beam_dataset/train", dxf_files=dxf_files)
...
if __name__ == "__main__":
    ...
    train_pipeline(dxf_files, save_dir="outputs/result/beam_pred/0114_ckpt")
