...
from docs.paper.experiments.research.beam_pred.beam_dataset import builder_to_pyg_data
from docs.paper.experiments.research.beam_pred.model import BeamPredictorGNN
from src.data_engine.preprocess.beam_ir_builder import StructuralGraphBuilder
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="outputs/result/beam_pred", help="输出图片路径")
