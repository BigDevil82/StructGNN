...
class EdgeDataConfig:
    ...
    TRAIN_DIR: str = (
        r"data\data\dxf\shearwall_split_8_2\train"  # Directory containing train DXF files (use filenames as keys)
    )
    TEST_DIR: str = (
        r"data\data\dxf\shearwall_split_8_2\test"  # Directory containing test DXF files (use filenames as keys)
    )
    CACHE_DIR: str = "data/cache/baseline_GNN-EP4-CV"
...
class EdgeTrainConfig:
    ...
    # Model save path
    MODEL_SAVE_PATH: str = "outputs/result/shearwall_pred/baseline-GNN-EP4-CV/baseline_edge_gnn.pt"
