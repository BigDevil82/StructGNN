...
from docs.paper.experiments.research.baseline_edge_gnn.dataset import EdgeShearWallDataset
from docs.paper.experiments.research.baseline_edge_gnn.model import GNNEP4
from docs.paper.experiments.research.baseline_edge_gnn.trainer import EdgeGNNTrainer
...
def main():
    ...
    if args.val_ratio > 0:
        train_keys, val_keys = train_test_split(train_keys, test_size=args.val_ratio, random_state=args.seed)
    else:
        val_keys = []
