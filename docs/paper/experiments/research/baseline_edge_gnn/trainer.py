...
from docs.paper.experiments.research.baseline_edge_gnn.config import train_config
from docs.paper.experiments.research.baseline_edge_gnn.model import GNNEP4, compute_edge_loss, compute_metrics
