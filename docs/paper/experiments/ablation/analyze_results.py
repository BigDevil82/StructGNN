...
class ScoreDCEvaluator:
    ...
    def __init__(
        ...
        from docs.paper.experiments.metrics.image_iou import ImageIoUCalculator
    ...
    def _image_iou(self, pred: torch.Tensor, gt: torch.Tensor, room_polys) -> float:
        ...
        from docs.paper.experiments.metrics.image_iou import vector_to_walls
...
def evaluate_experiment_conditional(
    ...
    返回各fold的评估结果和汇总统计
    """
    from docs.paper.experiments.ablation.config import get_ablation_config
    from docs.paper.experiments.ablation.models import create_model_from_config
