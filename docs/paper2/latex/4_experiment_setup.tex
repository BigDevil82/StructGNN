...
Representative finite element models generated from the same parametric workflow are shown in Fig.~\ref{fig:model_cases}. These cases illustrate how different story numbers, section dimensions, material grades, and seismic design conditions lead to distinct shear wall structural models within the dataset.
