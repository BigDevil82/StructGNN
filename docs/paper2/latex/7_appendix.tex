...
This appendix provides the calibration-model selection results used to support the online local calibration experiments in Section~\ref{subsec:local_calibration_results}. For each local sample size, the table reports the best-performing lightweight calibrator among the tested alternatives.
