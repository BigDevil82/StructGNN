...
The reinforcement surrogate outputs the predicted reinforcement usage $\hat{m}_{s}^{G}$. This output is used as the cost-related ranking signal before FEA. Since concrete quantity can be rapidly approximated from geometry and section dimensions, the global surrogate cost estimate is written as
\begin{equation}
