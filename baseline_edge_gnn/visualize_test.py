...
from baseline_edge_gnn.config import data_config, model_config, train_config
from baseline_edge_gnn.ensemble_model import EnsembleGNNEP4
from baseline_edge_gnn.graph_builder import EdgeGraphBuilder, build_graph_from_json, load_json_data
from baseline_edge_gnn.model import GNNEP4, compute_metrics
...
def main():
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="result/shearwall_pred/baseline-GNN-EP4/visualizations",
