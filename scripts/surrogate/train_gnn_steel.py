...
from src.surrogate.gnn.train_steel import GNNSteelTrainConfig, run_gnn_steel_train
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train GNN regressor for steel usage.")
    parser.add_argument(
        "--dataset-path",
    ...
    parser.add_argument("--graph-repr", choices=("member", "room"), default="room")
    parser.add_argument("--graph-cache-dir", default=None)
    parser.add_argument("--output-dir", default=r"data\parametric\surrogate_dataset\steel_gnn_room")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--batch-size", type=int, default=128)
    parser.add_argument("--max-epochs", type=int, default=50)
    parser.add_argument("--early-stop-rounds", type=int, default=8)
...
def main() -> None:
    ...
    metrics = run_gnn_steel_train(cfg)
